...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navlist variant="outline">
            ...
            <flux:navlist.group :heading="__('branch Management')" expandable :expanded="request()->routeIs('super-admin.branches.*')? true : false" class="grid">
                ...
                <flux:navlist.item icon="building-office-2" :href="route('super-admin.branches.deleted')"
                    :current="request()->routeIs('super-admin.branches.deleted')" wire:navigate>{{ __('Deleted Branches') }}
                </flux:navlist.item>
            </flux:navlist.group>
            <flux:navlist.group :heading="__('Super Admin')" expandable class="grid">
