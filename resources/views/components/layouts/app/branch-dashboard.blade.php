    ...
    <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navlist variant="outline">
            ...
            <flux:navlist.group :heading="__('Analytics')" expandable
                :expanded="request()->routeIs('branch-dashboard.analytics.*') ? true : false" class="grid" icon='chart-bar-square'>
                <flux:navlist.item icon="presentation-chart-line" :href="branch_route('branch-dashboard.analytics.stock-analytics')"
                    :current="request()->routeIs('branch-dashboard.analytics.stock-analytics')" wire:navigate>{{ __('Stock Analytics') }}
                </flux:navlist.item>
                <flux:navlist.item icon="user-circle" :href="branch_route('branch-dashboard.analytics.employee-usage')"
                    :current="request()->routeIs('branch-dashboard.analytics.employee-usage')" wire:navigate>{{ __('Employee Usage') }}
                </flux:navlist.item>
            </flux:navlist.group>
        </flux:navlist>
        <flux:spacer />
