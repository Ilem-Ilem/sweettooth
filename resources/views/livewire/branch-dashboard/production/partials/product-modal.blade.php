            ...
            <form wire:submit.prevent="save">
                ...
                <div class="border-b border-zinc-200 dark:border-zinc-700 pb-4 mb-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <!-- VAT Rate -->
                        <div>
                            <label class="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-2">VAT % (Optional)</label>
                            <input type="number" step="0.01" min="0" max="100" wire:model="vat_rate"
                                class="w-full px-4 py-2 border border-zinc-300 dark:border-zinc-600 rounded-lg bg-white dark:bg-zinc-800 text-zinc-900 dark:text-zinc-100 focus:ring-2 focus:ring-blue-500"
                                placeholder="Leave blank to use global VAT">
                            <p class="text-xs text-zinc-500 dark:text-zinc-400 mt-1">If empty, the global VAT rate will be applied.</p>
                            @error('vat_rate')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                            @enderror
                        </div>
