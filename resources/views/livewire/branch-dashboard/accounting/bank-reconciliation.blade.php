                ...
                <div class="col-md-3">
                    <div class="card border-left-info">
                        <div class="card-body">
                            ...
                            <h4>${{ number_format($stats['bank_balance'] ?? 0, 2) }}</h4>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card border-left-success">
                        <div class="card-body">
                            ...
                            <h4>${{ number_format($stats['book_balance'] ?? 0, 2) }}</h4>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    ...
                    <div class="card @if($isBalanced) border-left-success @else border-left-danger @endif">
                        <div class="card-body">
                            ...
                            <h4 class="@if($isBalanced) text-success @else text-danger @endif">
                                ${{ number_format(abs($stats['difference'] ?? 0), 2) }}
                            </h4>
                            @if($isBalanced)
                            ...
                            @foreach($glEntries as $entry)
                                <div class="list-group-item">
                                    <div class="d-flex justify-content-between align-items-start">
                                        ...
                                        <div class="text-end">
                                            <h6 class="mb-0">${{ number_format($entry['amount'], 2) }}</h6>
                            ...
                            @foreach($matchedPairs as $pair)
                                <div class="list-group-item">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="flex-grow-1">
                                            <small>${{ number_format($pair['amount'], 2) }}</small>
        ...
        <div class="col-12">
            ...
            @else
                <button class="btn btn-danger" disabled>
                    ✗ Cannot complete - Not balanced (Diff: ${{ number_format(abs($stats['difference'] ?? 0), 2) }})
                </button>
            @endif
        </div>
    </div>
            ...
            <div class="card border-success">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <h6 class="text-muted">Difference</h6>
                            <h5 class="text-success">${{ number_format($reconciliation->difference, 2) }}</h5>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <h4>${{ number_format($stats['matched_amount'] ?? 0, 2) }}</h4>
                        </div>
                    </div>
