                            ...
                            <table class="w-full">
                                ...
                                <tbody>
                                    ...
                                    <tr class="border-t border-zinc-200 dark:border-zinc-700">
                                        ...
                                        <td class="px-4 py-2">
                                            <input type="number" step="0.01" wire:model="purchaseItems.{{ $index }}.quantity"
                                        ...
                                        <td class="px-4 py-2">
                                            <input type="text" wire:model="purchaseItems.{{ $index }}.uom"
                                        ...
                                        <td class="px-4 py-2">
                                            <input type="number" step="0.01" wire:model="purchaseItems.{{ $index }}.unit_fob_fc"
