<div class="p-3 space-y-3">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h1 class="text-2xl font-bold text-zinc-900 dark:text-white">Shift Assignment</h1>
            <p class="text-zinc-600 dark:text-zinc-400">Assign employees to specific shifts</p>
        </div>
    ...
    <div class="flex justify-between items-center">
        <div>
            <h2 class="text-xl font-bold text-zinc-900 dark:text-white">Assigned Shifts for {{ $selectedShiftDate ? date('F j, Y', strtotime($selectedShiftDate)) : today()->format('F j, Y') }}</h2>
        </div>
