    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="space-y-4">
            <div class="bg-zinc-50 dark:bg-zinc-900 p-4 rounded-lg">
                ...
                <p class="text-zinc-900 dark:text-white font-medium">{{ $employee->email ?? '—' }}</p>
            </div>
            ...
            <div class="bg-zinc-50 dark:bg-zinc-900 p-4 rounded-lg">
                ...
                <p class="text-zinc-900 dark:text-white font-medium">
                    ...
                    @if($employee->date_of_birth)
                        <span class="text-xs text-zinc-500">({{ \Carbon\Carbon::parse($employee->date_of_birth)->age }} years old)</span>
                    @endif
                </p>
            </div>
        ...
        <div class="space-y-4">
            ...
            <div class="bg-zinc-50 dark:bg-zinc-900 p-4 rounded-lg">
                <label class="block text-xs font-semibold text-zinc-500 dark:text-zinc-400 uppercase mb-1">Allergies</label>
                <p class="text-zinc-900 dark:text-white font-medium">{{ $employee->allergies ?? 'None' }}</p>
            </div>
        </div>
    </div>
</div>