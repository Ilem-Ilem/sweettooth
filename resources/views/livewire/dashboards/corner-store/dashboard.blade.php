    ...
    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div class="overflow-hidden rounded-lg bg-white px-4 py-5 shadow sm:p-6">
            ...
            <dd class="mt-1 text-3xl font-semibold tracking-tight text-gray-900">
                {{ $currencySymbol }}{{ number_format($todaySales, 2) }}
            </dd>
        ...
        <div class="overflow-hidden rounded-lg bg-white px-4 py-5 shadow sm:p-6">
            ...
            <dd class="mt-1 text-3xl font-semibold tracking-tight text-gray-900">
                {{ $currencySymbol }}{{ number_format($averageTransactionValue, 2) }}
            </dd>
        ...
        <div class="overflow-hidden rounded-lg bg-white px-4 py-5 shadow sm:p-6">
            ...
            <dd class="mt-1 text-3xl font-semibold tracking-tight text-gray-900">
                {{ $currencySymbol }}{{ number_format($totalSales, 2) }}
            </dd>
            <p class="mt-2 text-sm text-gray-600">
                        ...
                        @forelse($topSellingItems as $item)
                            <tr>
                                ...
                                <td class="whitespace-nowrap px-6 py-4 text-sm font-medium text-gray-900">
                                    {{ $currencySymbol }}{{ number_format($item->total_sales, 2) }}
                                </td>
                            </tr>
                        @empty
                            <tr>
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white">
                        @forelse($recentTransactions as $transaction)
                            <tr>
                                ...
                                <td class="whitespace-nowrap px-6 py-4 text-sm font-medium text-gray-900">
                                    {{ $currencySymbol }}{{ number_format($transaction->total_amount, 2) }}
                                </td>
