...
class ShiftConfiguration extends BaseComponent
{
    ...
    public function store()
    {
        $this->validate([
            ...
            'shift_type' => 'required|string|max:50|unique:shift_configurations,shift_type,NULL,id,branch_id,' . $this->b_id,
    ...
    public function update()
    {
        $this->validate([
            'name' => 'required|string|max:255',
            'shift_type' => 'required|string|max:50|unique:shift_configurations,shift_type,' . $this->editingConfig . ',id,branch_id,' . $this->b_id,
            'start_time' => 'required|date_format:H:i',
            'end_time' => 'required|date_format:H:i',
            'clock_in_start' => 'required|date_format:H:i',
            'clock_in_end' => 'required|date_format:H:i|after:clock_in_start',
    ...
    private function resetForm()
    {
        ...
        $this->end_time = '14:00';
        $this->clock_in_start = '06:00';
        $this->clock_in_end = '12:00';
