...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $permissions = [
            ...
            ['name' => 'manage-suppliers', 'description' => 'Full supplier management', 'category' => 'inventory'],
            ['name' => 'view-suppliers', 'description' => 'View suppliers list', 'category' => 'inventory'],
            ['name' => 'create-suppliers', 'description' => 'Create new suppliers', 'category' => 'inventory'],
            ['name' => 'edit-suppliers', 'description' => 'Edit supplier information', 'category' => 'inventory'],
            ['name' => 'delete-suppliers', 'description' => 'Delete suppliers', 'category' => 'inventory'],
            ...
            ['name' => 'create-gl-entries', 'description' => 'Create general ledger entries', 'category' => 'accounting'],
            ['name' => 'post-gl-entries', 'description' => 'Post general ledger entries', 'category' => 'accounting'],
            ['name' => 'reverse-gl-entries', 'description' => 'Reverse general ledger entries', 'category' => 'accounting'],
