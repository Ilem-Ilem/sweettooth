...
class AdditionalDummyDataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $this->command->info('🚀 Starting additional dummy data seeding...');

        // Skip accounting periods since they're already created
        // Skip GL accounts since they're already created
        // Skip bank accounts since they're already created
        ...
        // 9. Create department-product relationships
        ...
        // 13. Create raw material utilization
        ...
        // 30. Create expiry confirmations
    ...
    private function createDepartments($branches)
    {
        ...
        foreach ($departments as $dept) {
            ...
            if ($existingDept) {
                $createdDepartments[] = $existingDept;
            } else {
    ...
    private function createUnitsOfMeasure()
    {
        ...
        foreach ($measures as $measure) {
            UnitOfMeasure::firstOrCreate(['name' => $measure['name']], $measure);
        }
    }
    ...
    private function createAdditionalGlEntries()
    {
        $faker = Faker::create();
